...
assert.strictEqual(defaultSummaryPayload.public_embeds, 3, "default summary should count reviewed public photo embeds");
assert.strictEqual(defaultSummaryPayload.public_photo_manifest_published_images, 3, "default summary should cite public photo manifest image count");
