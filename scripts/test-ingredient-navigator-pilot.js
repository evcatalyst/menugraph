...
assert(js.includes("Candy Wrapper Archive selected product queue status"), "navigator should label selected-product CWA queue status");
assert(js.includes("Why this product"), "navigator should explain selected CWA product prioritization");
assert(js.includes("hunt readable panels"), "navigator should show selected CWA product next action");
...
assert(js.includes("Candy Wrapper Archive Panel Candidate Review"), "navigator should expose CWA panel candidate review status");
assert(js.includes("Ingredient photos primary"), "navigator should state ingredient photos are primary");
...
assert(js.includes("Candy Wrapper Archive Grok Lead Review"), "navigator should expose CWA Grok lead review");
assert(js.includes("candidate leads"), "navigator should show CWA Grok lead review counts");
assert(js.includes("Grok Lead Review CSV"), "navigator should link CWA Grok lead review CSV");
assert(js.includes("Grok Lead Review Runbook"), "navigator should link CWA Grok lead review runbook");
assert(js.includes("Grok Lead Review JSON"), "navigator should link CWA Grok lead review JSON");
