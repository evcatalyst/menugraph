...
assert.strictEqual(labelDatabaseVisualIndex.totals.products, 2, "label database lane should add two products in this slice");
assert.strictEqual(labelDatabaseVisualIndex.totals.rows, 2, "label database lane should add two proof rows in this slice");
assert.strictEqual(labelDatabaseVisualIndex.totals.local_preview_available, 2, "label database lane should have local private proof panels");
...
assert.strictEqual(labelDatabaseFamily.product_count, 2, "label-database lane should expose two products");
