...
test("ingredient navigator renders CWA visual timeline without relying on public image pixels", async ({ page }) => {
  ...
  await expect(sourceFamilySummary).toContainText("148");
  ...
  await expect(sourceFamilySummary.locator(".source-family-focus-metric[aria-label='14 proof text candidates']")).toBeVisible();
  await expect(sourceFamilySummary.locator(".source-family-focus-metric[aria-label='16 local visuals']")).toBeVisible();
  await expect(sourceFamilySummary.locator(".source-family-focus-metric[aria-label='14 structured ingredient rows']")).toBeVisible();
  await expect(sourceFamilySummary.locator(".source-family-focus-metric[aria-label='2 readable panel gaps']")).toBeVisible();
